...
extension GetOfflineCategoryCollection on Isar {
  IsarCollection<OfflineCategory> get offlineCategorys => this.collection();
}

const OfflineCategorySchema = CollectionSchema(
  name: r'OfflineCategory',
  id: 600303929643686473,
  properties: {
  ...
  estimateSize: _offlineCategoryEstimateSize,
  serialize: _offlineCategorySerialize,
  deserialize: _offlineCategoryDeserialize,
  deserializeProp: _offlineCategoryDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _offlineCategoryGetId,
  getLinks: _offlineCategoryGetLinks,
  attach: _offlineCategoryAttach,
  version: '3.1.0+1',
);

int _offlineCategoryEstimateSize(
  OfflineCategory object,
  List<int> offsets,
...
void _offlineCategorySerialize(
  OfflineCategory object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
OfflineCategory _offlineCategoryDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = OfflineCategory();
...
P _offlineCategoryDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _offlineCategoryGetId(OfflineCategory object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _offlineCategoryGetLinks(OfflineCategory object) {
  return [];
}

void _offlineCategoryAttach(
    IsarCollection<dynamic> col, Id id, OfflineCategory object) {
  object.id = id;
}

extension OfflineCategoryQueryWhereSort
    on QueryBuilder<OfflineCategory, OfflineCategory, QWhere> {
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterWhere> anyId() {
...
extension OfflineCategoryQueryWhere
    on QueryBuilder<OfflineCategory, OfflineCategory, QWhereClause> {
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterWhereClause> idEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterWhereClause>
      idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterWhereClause> idLessThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension OfflineCategoryQueryFilter
    on QueryBuilder<OfflineCategory, OfflineCategory, QFilterCondition> {
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterFilterCondition>
      cachedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension OfflineCategoryQueryObject
    on QueryBuilder<OfflineCategory, OfflineCategory, QFilterCondition> {}

extension OfflineCategoryQueryLinks
    on QueryBuilder<OfflineCategory, OfflineCategory, QFilterCondition> {}

extension OfflineCategoryQuerySortBy
    on QueryBuilder<OfflineCategory, OfflineCategory, QSortBy> {
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy>
      sortByCachedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy> sortByIsLocal() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
...
extension OfflineCategoryQuerySortThenBy
    on QueryBuilder<OfflineCategory, OfflineCategory, QSortThenBy> {
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy>
      thenByCachedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cachedAt', Sort.asc);
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.desc);
    });
  }

  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy> thenByIsLocal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocal', Sort.asc);
    });
  }
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }
...
extension OfflineCategoryQueryWhereDistinct
    on QueryBuilder<OfflineCategory, OfflineCategory, QDistinct> {
  QueryBuilder<OfflineCategory, OfflineCategory, QDistinct>
      distinctByCachedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OfflineCategory, OfflineCategory, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension OfflineCategoryQueryProperty
    on QueryBuilder<OfflineCategory, OfflineCategory, QQueryProperty> {
  QueryBuilder<OfflineCategory, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<OfflineCategory, DateTime?, QQueryOperations>
      cachedAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OfflineCategory, bool, QQueryOperations> isLocalProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isLocal');
    });
  }

  QueryBuilder<OfflineCategory, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
