...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'validation_selling_price_greater_than_initial_price': 'Selling price must be greater than or equal to initial price',
          'product_add_success': 'Product has been added',
          'global_error_occurred': 'An error occurred. Please try again.',
        ...
        'id_ID': {
          ...
          'validation_selling_price_greater_than_initial_price': 'Harga jual harus lebih besar atau sama dengan harga awal',
          'product_add_success': 'Produk berhasil ditambahkan',
          'global_error_occurred': 'Terjadi kesalahan. Silakan coba lagi.',
